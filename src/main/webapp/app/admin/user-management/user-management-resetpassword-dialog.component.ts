...
@Component({
  selector: 'jhi-user-mgmt-resetpassword-dialog',
  templateUrl: './user-management-resetpassword-dialog.component.html',
})
export class UserManagementResetPasswordDialogComponent {
  ...
  confirmReset(login: string): void {
    this.userService.resetPassword(login).subscribe(() => {
